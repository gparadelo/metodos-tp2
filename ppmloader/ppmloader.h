...
typedef enum _PPM_LOADER_PIXEL_TYPE {
...
bool SavePPMFile(const char *filename, const void *src, int width, int height, PPM_LOADER_PIXEL_TYPE pt, const char* comments = 0);
